...
internal static class Program
{
    ...
    private static Schedule Welcome() => new Schedule(
        () => Logger.Information("3, 2, 1, live!"),
        run => run.Now()
    );

    private static Schedule NonReentrant() => new Schedule(() =>
        {
